...
<div class = "modal fade" id = "myModal6" tabindex = "-1" role = "dialog"
   ...
   <div class = "modal-dialog">
      <div class = "modal-content">
         ...
         <form action="elitic" method="POST">
         <div class = "modal-body">
         <input type="hidden" id="idtic" name="idtic">
            <div class=" ">Desea eliminar el ticket de atencion? Este registro quedara en su historial, hagalo solo cuando sea necesario</div>
